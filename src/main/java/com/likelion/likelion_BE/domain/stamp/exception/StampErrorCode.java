...
public enum StampErrorCode implements BaseCode {
    ...
    STAMP_IMAGE_REQUIRED(HttpStatus.BAD_REQUEST, "STAMP400_5", "인증 이미지는 필수 입력값입니다."),
    INVALID_AUTH_DATE(HttpStatus.BAD_REQUEST, "STAMP400_6", "인증 날짜는 미션 진행 기간 내의 날짜여야 합니다.");
